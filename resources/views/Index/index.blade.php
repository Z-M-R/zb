...
<div style="float:right;width=30%;height:600px;">
    <div class="onlinelist" style="float:right;border: 1px solid #000000; width:100px;height:600px;"><p style="text-align:center;color:red;">在线列表</p></div>
    <div style="float:left;border: 1px solid #000000;">
        <div style="width:250px;height:400px;overflow:auto" id="list"></div>
